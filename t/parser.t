...
my %se = Config::MVP::parse($seventh);
...
my %te = Config::MVP::parse-file($tenth);
...
my %el = Config::MVP::parse($eleventh);

pass 'eleventh config parsed';
is-deeply %el, {
    '_' => {
        foo => [ '42', '84' ],
        bar => 'whatever',
